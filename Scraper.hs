...
-- *Scraper> let html = tagTree $ parseTags testHtmlStr 
-- *Scraper> let tr = subTree (Just "tr") Nothing html
-- *Scraper> tr
...
-- *Scraper> length tr
-- 2
-- *Scraper> let td = subTree (Just "td") Nothing html
-- *Scraper> td
-- [TagBranch "td" [] [TagLeaf (TagText "hoho")],TagBranch "td" [("class","date")] [TagLeaf (TagText "2012-09-09")],TagBranch "td" [] [TagLeaf (TagText "ooo")]]
-- *Scraper> length td
-- 3
-- *Scraper> mapM_ print td
-- TagBranch "td" [] [TagLeaf (TagText "hoho")]
-- TagBranch "td" [("class","date")] [TagLeaf (TagText "2012-09-09")]
-- TagBranch "td" [] [TagLeaf (TagText "ooo")]
-- *Scraper>
